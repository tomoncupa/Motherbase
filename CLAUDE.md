...
| `_smoke.html` | 299 checks over all of the above. Run it after touching any of them. |
...
3. Run `_review.html` at the root. It opens every app in turn, checks each one
   ...
   It must say 299 of 299, or more once you add checks.
...
| `shared/` | The foundation, passing 299 checks on 2026-09-17 (214 of them also at phone width, counted 2026-09-14). Every app loads it. |
