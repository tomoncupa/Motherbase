...
| `_smoke.html` | 306 checks over all of the above. Run it after touching any of them. |
...
3. Run `_review.html` at the root. It opens every app in turn, checks each one
   ...
   It must say 306 of 306, or more once you add checks.
...
| `shared/` | The foundation, passing 306 checks on 2026-09-17 at BOTH desktop and phone width. Every app loads it. |
