...
| `_smoke.html` | 312 checks over all of the above. Run it after touching any of them. |
...
3. Run `_review.html` at the root. It opens every app in turn, checks each one
   ...
   working on the foundation and want the 312 without the apps.
   It must say 312 of 312, or more once you add checks.
...
| `shared/` | The foundation, passing 312 checks on 2026-09-17 at BOTH desktop and phone width. Every app loads it. |
