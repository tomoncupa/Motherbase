# WEALTH history (HISTORY.md)

This file is not auto-loaded. It holds the build diary moved out of
`wealth/CLAUDE.md` on 2026-09-23: how each feature was built, what Tom said,
and what was watched in the browser. The rules those stories set are
summarised in `CLAUDE.md`, each pointing back to its heading here. Read the
section for the corner you are working in. Everything below is verbatim.
